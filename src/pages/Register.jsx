    ...
    return (
        <div className='bg-slate-300 w-3/12'>
            ...
            <form onSubmit={handleSubmit}>
                <Input type="text" value={name} onChange={handleNameChange} className="m-4 w-10/12" placeholder='Nome' />
                <Input type="text" value={name} onChange={handleNameChange} className="m-4 w-10/12" placeholder='SobreNome' />
